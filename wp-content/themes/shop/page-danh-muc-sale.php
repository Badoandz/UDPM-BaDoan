...
<header class="tn-header">
	<div class="tn-container tn-header__inner">
		...
		<nav class="tn-nav">
			...
			<a href="<?php echo esc_url(get_permalink(get_page_by_path('danh-muc-sale')->ID)); ?>" class="active">Danh mục sale</a>
...
<div class="breadcrumb-section">
	<div class="tn-container">
		<nav class="breadcrumb">
			...
			<span class="breadcrumb-current">Sản phẩm khuyến mãi</span>
		</nav>
	</div>
</div>
                ...
                <div class="filters-sidebar">
                    ...
                    <div class="filter-section">
                        ...
                        <div class="color-options">
                            ...
                            <div class="color-item">
                                <input type="checkbox" id="color-cream" class="color-checkbox">
                                <label for="color-cream" class="color-label">
                ...
                <div class="products-main">
                    ...
                    <div class="products-header">
                        <div class="products-title-section">
                            <h1 class="products-title">Sản phẩm khuyến mãi</h1>
                            <span class="products-count">57 sản phẩm</span>
                        </div>
                    ...
                    <div class="products-grid">
                        <!-- Product 1 - White Polo -->
                        <div class="product-card">
                            <div class="product-image">
                                <img src="https://images.unsplash.com/photo-1594938298603-c8148c4dae35?q=80&w=400&auto=format&fit=crop" alt="Áo polo monogram in tràn họa tiết GSTP051">
                            ...
                            <div class="product-info">
                                ...
                                <h3 class="product-name">Áo polo monogram in tràn họa tiết GSTP051</h3>
                        ...
                        <!-- Product 2 - Cream Polo -->
                        <div class="product-card">
                            <div class="product-image">
                                <img src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?q=80&w=400&auto=format&fit=crop" alt="Áo Polo trơn bo kẻ FSTP003">
                                <div class="discount-badge">-34%</div>
                            </div>
                            <div class="product-info">
                                <div class="product-variants">
                                ...
                                <h3 class="product-name">Áo Polo trơn bo kẻ FSTP003</h3>
                                <div class="product-price">
